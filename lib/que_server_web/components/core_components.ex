defmodule QueServerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(QueServerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(QueServerWeb.Gettext, "errors", msg, opts)
    end
  end
